        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <form role="form" method="POST" action="{{route('banner.update', $banner->id)}}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="summary" class="form-control" rows="3"
                                          placeholder="Enter ...">{{$banner->summary}}</textarea>
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="box-body">
                            <div class="form-group">
                                <img src="{{asset('photo/banner/'.$banner->photo)}}" width="100%" id="preview"
                                     alt="photo banner">
